Feature: Login Sauce Demo
  Background: User login into Sauce Demo page //Historia de ususario o descripcion de lo que se hará
    Given Im in sauce demo web page

    @loginWithValidCredentials
    Scenario: Login into Sauce Demo page with valid credentials //titulo del test case
